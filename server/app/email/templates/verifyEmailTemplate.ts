...
const verifyEmailTemplate = function (
  ...
  const html = `
    ...
    <body
      ...
      <div style="display: none;">Se ha creado la cuenta ${accountName} para FacturazoCRM.
Usa el siguiente código para confirmarla</div>
                      ...
                      <tr>
                        <td class="sm-px-24"
                          style="--bg-opacity: 1; background-color: #ffffff;  border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;"
                           align="left">
                          <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Saludos,</p>

                          <p style="margin: 0 0 24px;">
                            Se ha creado una cuenta con el nombre ${accountName}.
                            Usa el siguiente código de verificación para verificar tu cuenta.
                          </p>
                          ...
                          <p style="margin: 0 0 16px;">
                            Necesita soporte  adicional? Por favor contáctenos con el siguiente correo:
                            <a href="mailto:${supportEmail}" class="hover-underline"
                              style="--text-opacity: 1; color: #7367f0;  text-decoration: none;">${supportEmail}</a>.
                          </p>
                          <p style="margin: 0 0 16px;">Gracias de antemano, <br>${supportName}</p>
                        </td>
                      </tr>
                      <tr>
