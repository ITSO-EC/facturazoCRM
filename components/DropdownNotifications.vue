        ...
        >
          <li class="border-b border-slate-200 last:border-0">
            <router-link class="block py-2 px-4 hover:bg-slate-50" to="#0" @click="dropdownOpen = false">
              <span class="block text-sm mb-2">📣 <span class="font-medium text-blackColor">Edit your information in a swipe</span> Sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim.</span>
          ...
          <li class="border-b border-slate-200 last:border-0">
            <router-link class="block py-2 px-4 hover:bg-slate-50" to="#0" @click="dropdownOpen = false">
              <span class="block text-sm mb-2">🚀<span class="font-medium text-blackColor">Say goodbye to paper receipts!</span> Sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim.</span>
