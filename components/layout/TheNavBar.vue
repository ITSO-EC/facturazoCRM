...
import  FlameLogoBig  from "~~/components/elements/Logos/FlameLogo.vue";
...
const setColorTheme = (newTheme: Theme) => {
  console.log("changing", colorMode.preference)
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-between  border-b-2 border-gray-100">
        ...
        <div class="flex justify-between space-x-5 align-bottom mt-14">
          ...
          <NuxtLink to="https://github.com/jurassicjs/avantage">
