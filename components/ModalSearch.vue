      ...
      <div ref="modalContent" class="bg-white overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg">
        ...
        <div class="py-4 px-2">
          ...
          <div class="mb-3 last:mb-0">
            ...
            <ul class="text-sm">
              <li>
                <router-link class="flex items-center p-2 text-blackColor hover:text-white hover:bg-indigo-500 rounded group" to="#0" @click="$emit('close-modal')">
            ...
            <ul class="text-sm">
              <li>
                <router-link class="flex items-center p-2 text-blackColor hover:text-white hover:bg-indigo-500 rounded group" to="#0" @click="$emit('close-modal')">
                  ...
                  <span><span class="font-medium text-blackColor group-hover:text-white">Messages</span> - Conversation / … / Mike Mills</span>
                </router-link>
              </li>
              <li>
                <router-link class="flex items-center p-2 text-blackColor hover:text-white hover:bg-indigo-500 rounded group" to="#0" @click="$emit('close-modal')">
                  ...
                  <span><span class="font-medium text-blackColor group-hover:text-white">Messages</span> - Conversation / … / Eva Patrick</span>
                </router-link>
              </li>
            </ul>
          </div>
